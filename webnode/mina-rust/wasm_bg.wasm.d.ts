...
export function jshandle_zkapp_inject(a: number, b: number): number;
export function jshandle_watched_accounts(a: number): number;
export function __wbg_watchedaccounts_free(a: number): void;
export function watchedaccounts_add(a: number, b: number, c: number, d: number, e: number): number;
export function watchedaccounts_get(a: number, b: number, c: number, d: number, e: number): number;
export function watchedaccounts_get_latest_state(a: number, b: number, c: number, d: number, e: number): number;
...
export function _dyn_core__ops__function__FnMut___A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h34aedc8eb09c0dc1(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h5dcd699f8b61e048(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hf7bf7d90409999f3(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h573cb6e341826029(a: number, b: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h97aebef290354075(a: number, b: number, c: number, d: number): void;
