...
* @returns {Promise<any>}
*/
  zkapp_inject(zkapp_js: any): Promise<any>;
/**
...
*/
  add(pub_key: string, token_id?: string): Promise<boolean>;
/**
* @param {string} pub_key
* @param {string | undefined} token_id
* @returns {Promise<any>}
*/
  get(pub_key: string, token_id?: string): Promise<any>;
/**
* @param {string} pub_key
* @param {string | undefined} token_id
* @returns {Promise<any>}
*/
  get_latest_state(pub_key: string, token_id?: string): Promise<any>;
}
...
export interface InitOutput {
  ...
  readonly jshandle_zkapp_inject: (a: number, b: number) => number;
  readonly jshandle_watched_accounts: (a: number) => number;
  readonly __wbg_watchedaccounts_free: (a: number) => void;
  readonly watchedaccounts_add: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly watchedaccounts_get: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly watchedaccounts_get_latest_state: (a: number, b: number, c: number, d: number, e: number) => number;
  ...
  readonly _dyn_core__ops__function__FnMut___A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h34aedc8eb09c0dc1: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h5dcd699f8b61e048: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hf7bf7d90409999f3: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h573cb6e341826029: (a: number, b: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h97aebef290354075: (a: number, b: number, c: number, d: number) => void;
